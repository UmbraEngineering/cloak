;require._modules["/cloak/lib/q.js"] = (function() { var __filename = "/cloak/lib/q.js"; var __dirname = "/cloak/lib"; var module = { loaded: false, exports: { }, filename: __filename, dirname: __dirname, require: null, call: function() { var require = module.require; module.loaded = true; module.call = function() { }; __module__(); }, parent: null, children: [ ] }; var exports = module.exports; 
 /* ==  Begin source for module /cloak/lib/q.js  == */ var __module__ = function() { 
 // vim:ts=4:sts=4:sw=4:
/*!
 *
...
Promise.prototype.ninvoke = deprecate(ninvoke, "ninvoke", "q/node ninvoke");
 ...
 }; /* ==  End source for module /cloak/lib/q.js  == */ module.require = require._bind(module); return module; }());;